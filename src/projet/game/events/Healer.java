...
public class Healer implements Events {
	...
	public Healer() {
		...
		// ArrayList<String> allGreetingsQuotes = new
		// ArrayList<String>(Arrays.asList("Come hero, let me heal you", "We are here to
		// protect the brave!", "Welcome to our healing center!"));
		// ArrayList<String> allFarewellsQuotes = new
		// ArrayList<String>(Arrays.asList("My sisters are here for you!", "Stay safe!",
		// "May we meet again!"));
		// this.greetingQuote = allGreetingsQuotes.get(new
		// Random().nextInt(allGreetingsQuotes.size()));
		...
		var quotes1 = new HashMap<String, String>() {
			...
			*/
			...
			{
				put("The curses can't hurt you now.",
						"\"I sense a great disturbance.\" she says. \"Something horrible has been placed in your backpack. Let me see.\" She removes a single quill and pokes it into your bag carefully in several spots. \"That should do it,\" she says.");
			}
		};
		...
		var quotes2 = new HashMap<String, String>() {
			...
			*/
			...
			{
				put("\"She runs her paw across your wounds. The quills on her back shake and you are lost in the sound of them. When you come to, many wounds are healed.\"",
						healerQuotes1.get(new Random().nextInt(healerQuotes1.size())));
			}
		};
		...
		var healerQuotes2 = new ArrayList<String>(
				Arrays.asList("I see your strength.", "You are stronger now than before.",
		...
		var quotes3 = new HashMap<String, String>() {
			...
			*/
			...
			{
				put(narratorQuotes2.get(new Random().nextInt(narratorQuotes2.size())),
						healerQuotes2.get(new Random().nextInt(healerQuotes2.size())));
			}
		};
