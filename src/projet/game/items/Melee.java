...
public class Melee implements Weapons {
	...
	public Melee(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Melee copie() {
		return new Melee(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
