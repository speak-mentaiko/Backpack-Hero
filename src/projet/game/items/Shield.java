...
public class Shield implements Items {
	...
	public Shield(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Shield copie() {
		return new Shield(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
