...
public class Arrow implements Weapons {
	...
	public Arrow(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Arrow copie() {
		return new Arrow(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
