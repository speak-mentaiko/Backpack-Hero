...
public class Bow implements Weapons {
	...
	public Bow(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Bow copie() {
		return new Bow(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
