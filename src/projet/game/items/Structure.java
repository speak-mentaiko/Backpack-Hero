...
public class Structure implements Items {
	...
	public Structure(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
			HashMap<String, Integer> onUse, int[][] size, int energy, int gold, int mana, String rarety,
			String description) {
	...
	public Structure copie() {
		return new Structure(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
				cost.get("Energy"), cost.get("Gold"), cost.get("Mana"), rarety, description);
	}
