...
public class Wand implements Weapons {
	...
	public Wand(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Wand copie() {
		return new Wand(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size, rarety,
