...
public class Armor implements Items {
	...
	public Armor(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
	...
	@Override
	public Armor copie() {
		return new Armor(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size,
