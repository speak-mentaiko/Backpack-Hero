...
public class Magic implements Items {
	...
	public Magic(String name, String imgPath, HashMap<String, Integer> passif, HashMap<String, Integer> eachTurn,
			HashMap<String, Integer> onUse, int[][] size, String rarety, int energy, int gold, int mana,
			String description) {
	...
	@Override
	public Magic copie() {
		return new Magic(name, imgPath, passifInteraction, eachTurnInteraction, onUseInteraction, size, rarety,
				cost.get("Energy"), cost.get("Gold"), cost.get("Mana"), description);
	}
